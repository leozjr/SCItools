function [] = dispCubeAll(datacube,brightness,mywl,labelss,writefile,grayc,resultname)
...
wltextposition = [12 40]; %[12 12];
m=size(datacube,3);
for ind=1:m
    datacube(:,:,ind)=flipud(datacube(:,:,ind)); % up side dowm
end
imagedatacube2(h,double(datacube),brightness,mywl,labelss,wltextposition,writefile,grayc,resultname);




function imagedatacube2(h, data,mymax,wavelengths,labelss,textposition,writefile,grayc,resultname)
